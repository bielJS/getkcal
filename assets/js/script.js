...
function handleSubmit(event) {
  ...
  <button id="action--close" 
  onclick="(function(){
    const yourResult = document.querySelector('.result-container');
    yourResult.classList.add('hide');
    })()"
...
//Pegando valores dos inputs e convertendo em números
...
function reset(){
  const yourResult = document.querySelector('.result-container');
  yourResult.classList.remove('hide');
  }